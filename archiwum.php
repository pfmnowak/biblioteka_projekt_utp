					...
					if(isset($_SESSION['id_bibl'])) {
						...
						try {
							...
							if($polaczenie->connect_errno!=0) {
								...
								$rezultat = $polaczenie->query("SELECT w.data_zwrotu, e.id, k.tytul, k.rok_wydania, a.nazwisko, w.data_wypozyczenia, w.idc FROM wypozyczenie AS w, egzemplarz AS e, ksiazka AS k, autor AS a WHERE w.oddana = '1' AND w.ide = e.id AND e.idk = k.id AND k.ida = a.id ORDER BY w.data_zwrotu DESC");
